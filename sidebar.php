...
$my_market_query = new WP_Query('cat=409&'."monthnum=$month&year=$year&day=$day&hour=$hour" );
  ...
  <ul class="blurbs">
    ...
    <li class="marketBlurb"><strong>Student Focus Pages</strong><br />
      It's about making your own faith decisions now. A lot of students walk away from the faith, and one main reason is they're not sure it's true. These pages are here to help you understand why a lot of people are convinced it is, and yet always to respect your questions along the way.</li>
